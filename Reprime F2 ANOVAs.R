...
# CAT: Collapsed over item sbsetting
...
cat.sum <- data.frame(
  Head.Noun  = c("Related HN","Related HN","Unrelated HN","Unrelated HN"),
  Local.Noun = c("Related LN","Unrelated LN","Related LN", "Unrelated LN"),
  Voice.time = c(mean(HeadN.NRel$vtime),
                 mean(HeadN.NUnr$vtime),
                 mean(UnrHead.NRel$vtime),
                 mean(UnrHead.NUnr$vtime)),
...
# PROP: Collapsed items subsetting
...
# PROP (Rel vs. Unr): Collapse over item
d.prop$unique.id <- paste(d.prop[, 2], d.prop[, 3], d.prop[, 4], d.prop[, 5], sep = "_")
d.prop           <- ddply(d.prop, "unique.id", function(X) data.frame(vtime = mean(X$vtime)))
vtime            <- data.frame(d.prop$vtime)
d.prop           <- colsplit(d.prop$unique.id, "_", c("item", "subexp", "headrel", "localrel"))
...
# PROP (Rel vs. Unr): All items subsetting
HeadN.base         <- subset(d.prop.base, headrel   ==  "HeadN") 
UnrHead.base       <- subset(d.prop.base, headrel   ==  "UnrHead")
NRel.base          <- subset(d.prop.base, localrel  ==  "NRel") 
NUnr.base          <- subset(d.prop.base, localrel  ==  "NUnr") 
...
# PROP (Rel vs. Unr): Collapsed items subsetting
HeadN         <- subset(d.prop, headrel   ==  "HeadN") 
UnrHead       <- subset(d.prop, headrel   ==  "UnrHead")
NRel          <- subset(d.prop, localrel  ==  "NRel") 
NUnr          <- subset(d.prop, localrel  ==  "NUnr") 
...
# PROP (Assc vs. Unr): Collapse over item
d.prop$unique.id <- paste(d.prop[, 2], d.prop[, 3], d.prop[, 4], d.prop[, 5], sep = "_")
d.prop           <- ddply(d.prop, "unique.id", function(X) data.frame(vtime = mean(X$vtime)))
vtime            <- data.frame(d.prop$vtime)
d.prop           <- colsplit(d.prop$unique.id, "_", c("item", "subexp", "headrel", "localrel"))
...
# PROP (Assc vs. Unr): All items subsetting
HeadN.base         <- subset(d.prop.base, headrel   ==  "HeadN") 
UnrHead.base       <- subset(d.prop.base, headrel   ==  "UnrHead")
NUnr.base          <- subset(d.prop.base, localrel  ==  "NUnr") 
NAssc.base         <- subset(d.prop.base, localrel  ==  "NAssc")
...
# PROP (Assc vs. Unr): Collapsed items subsetting
HeadN         <- subset(d.prop, headrel   ==  "HeadN") 
UnrHead       <- subset(d.prop, headrel   ==  "UnrHead")
NUnr          <- subset(d.prop, localrel  ==  "NUnr") 
NAssc         <- subset(d.prop, localrel  ==  "NAssc")
...
# PROP (Assc vs. Rel): Collapse over item
d.prop$unique.id <- paste(d.prop[, 2], d.prop[, 3], d.prop[, 4], d.prop[, 5], sep = "_")
d.prop           <- ddply(d.prop, "unique.id", function(X) data.frame(vtime = mean(X$vtime)))
vtime            <- data.frame(d.prop$vtime)
d.prop           <- colsplit(d.prop$unique.id, "_", c("item", "subexp", "headrel", "localrel"))
...
# PROP (Assc vs. Rel): All items subsetting
HeadN.base         <- subset(d.prop.base, headrel   ==  "HeadN") 
UnrHead.base       <- subset(d.prop.base, headrel   ==  "UnrHead")
NRel.base          <- subset(d.prop.base, localrel  ==  "NRel") 
NAssc.base         <- subset(d.prop.base, localrel  ==  "NAssc")
...
# PROP (Assc vs. Rel): Collapsed items subsetting
HeadN         <- subset(d.prop, headrel   ==  "HeadN") 
UnrHead       <- subset(d.prop, headrel   ==  "UnrHead")
NRel          <- subset(d.prop, localrel  ==  "NRel") 
NAssc         <- subset(d.prop, localrel  ==  "NAssc")
...
# SEMREL: Collapsed items subsetting
